...
<?php
 ...
 else
 {
   ...
   */
   ...
   {
    echo '<tr><td>' . $r->jour . '/' . $r->mois . '/' . $r->annee . ' : </td><td><a href="reflexions/?forum=contrescarpe:' . $r->sujet . '&titrepage=' . $r->sujet . '">' . $r->sujet . '</a></td></tr>';
   }
  }
...
echo '<br><a href="http://membres.lycos.fr/teledev/contrescarpe-f.php?hist=oui">historique</a>';
...
<h4>&nbsp;Animé en alternance par Marian Sznyter et Michel Turrini
