...
=begin
    mypaint.setColor(0xFF119922) 
    canvas.drawCircle(120, 80, 60, mypaint) 

    mypaint.setColor (0xFF885511) 
    canvas.drawCircle (90,  150, 40, mypaint) 
=end
    ...
    y=1 
	  for x in 1..150
	    for y in 50..150 
          ...
          # mypaint.setColor(0xFF000000 + x * 0x10000 + y *  0x100 )
        ...
        if (xx*xx+yy*yy > 4) 
         mypaint.setColor (0xFF000000 + 0x10000 * t * 10 + 0x100 * (xx*xx+yy*yy) * 10)
         canvas.drawPoint (x, y, mypaint) 
        end
       end	 
	  end 
