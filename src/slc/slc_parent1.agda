...
-}
 side true (RUL "gparent") = lambda "x" (lambda "y" (lambda "z" (APL (APL (APL (SYM "parent") (SYM "x")) (SYM "y")) (APL (APL (APL (SYM "parent") (SYM "y")) (SYM "z")) (APL (APL (SYM "gparent") (SYM "x")) (SYM "z"))))))
 side false (RUL "gparent") = lambda "x" (lambda "y" (lambda "z" (DBL (DBV O))))
 side true (RUL "axiom1") = APL (APL (SYM "parent") (SYM "Allan")) (SYM "Brenda")
 side false (RUL "axiom1") = DBL (DBV O)
 side true (RUL "axiom2") = APL (APL (SYM "parent") (SYM "Brenda")) (SYM "Charles")
