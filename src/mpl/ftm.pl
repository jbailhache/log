...
while (<FORTH>)
{
 ...
 for ($i=0; $i<$n; $i++)
 {
  ...
  {
   print MPLS "h,[$w]W{[$w"."_ret]W#4,[sp]R-,[sp]W[adr_$w],[sp]RW#,[$w"."_ret]R?}";
   $state = 'run';
  }
  ...
  {
   print MPLS "#4,[sp]R+,[sp]W";
  }
  elsif ($w eq 'DUP')
  {
   print MPLS "[sp]RR,[st]W#4,[sp]R-,[sp]W[st]R,[sp]RW";
  }
  elsif ($w eq 'SWAP')
  {
   print MPLS "[sp]RR,[st]W#4,[sp]R+R,[su]WR,[sp]RW#4,[sp]R+,[adr]W[st]R,[adr]RW";
  }
  elsif ($w eq '@')
  {
  ...
  { 
   print MPLS "[sp]RR,[adr]W#4,[sp]R+,[sp]WRR,[adr]RW#4,[sp]R+,[sp]W";
  }
  elsif ($w eq 'KEY')
  {
   print MPLS "#4,[sp]R-,[sp]WG,[sp]RW";
  }
  elsif ($w eq 'EMIT') 
  { 
   print MPLS "[sp]RRP#4,[sp]R+,[sp]W";
  }
  elsif ($w eq 'HERE')
  {
   print MPLS "#4,[sp]R-,[sp]Wh,[sp]RW";
  }
  elsif ($w eq 'SP@')
  {
   print MPLS "#4,[sp]R-,[sp]W#4,[sp]R+,[sp]RW";
  }
  elsif ($w eq '[')
  {
   print MPLS "}";
