...
float q, sq, fq, a, b, q1, C, d, dqx, dqy, dCx, dCy, pi, spi, fpi;
...
float pim;
	...
	for (c=0; c<MAX_ABCISSE; c++)
		putpixel (c, MAX_ORDONNEE-lm, 0);
	for (l=0; l<MAX_ORDONNEE; l++)
		putpixel (cm, MAX_ORDONNEE-l, 0);
}
