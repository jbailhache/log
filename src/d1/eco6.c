...
char buf [200];
	...
	for (c=0; c<MAX_ABCISSE; c++)
	{
		...
		putpixel (c, MAX_ORDONNEE - scale * Cv, 3);
		putpixel (c, MAX_ORDONNEE - scale * Cf, 5);
		putpixel (c, MAX_ORDONNEE - scale * CT, 7);
		putpixel (c, MAX_ORDONNEE - scale * CM, 9);
		putpixel (c, MAX_ORDONNEE - scale * CVM, 10);
		putpixel (c, MAX_ORDONNEE - scale * Cm, 11);
