...
expr ctx;
  ...
  "read_expr @ print_symbol "
  "read_expr @ print_int "
  "' [' Rebonjour place readon return ]' rbj ' 4 + ! "
  "read_expr @ print_symbol "
  ...
  "quit ]nil nil nil nil 0 0 0 ][[nest read_expr endnest place readon return ]& testnest ][[' 3 ' 4 + place readon return ]&][rbj ]ttt ");
  BUF(ctx) = alloc(200);
  for (;;)
  {
   evol(ctx);
