// fmservwSet.cpp : implementation of the CFmservwSet class
//
...
/////////////////////////////////////////////////////////////////////////////
// CFmservwSet implementation

IMPLEMENT_DYNAMIC(CFmservwSet, CRecordset)

CFmservwSet::CFmservwSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	//{{AFX_FIELD_INIT(CFmservwSet)
	m_ID = _T("");
	m_FILE = _T("");
	m_CNX = _T("");
	m_DCNX = _T("");
...
CString CFmservwSet::GetDefaultConnect()
{
	return _T("ODBC;DSN=AT01");
}

CString CFmservwSet::GetDefaultSQL()
{
	return _T("[REC]");
}

void CFmservwSet::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(CFmservwSet)
...
/////////////////////////////////////////////////////////////////////////////
// CFmservwSet diagnostics

#ifdef _DEBUG
void CFmservwSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CFmservwSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
