...
/*	String src = " { [message \"Test\" \"Bonjour\" #300# #100#] } ";*/
	...
	/*String src = " { [mail \"smtp.noos.fr\" \"jacques.bailhache@lycos.fr\" \"j.bailhache@amplitude.fr\" \"Test mail\" \"Ceci est un test\" (PAGES \"aaa\" \"bbb\" \"ccc\") \".dat\"] } "; */

	String src = " { [print rep getfaxpages \"localhost\" #6020# \"admin\" \"padmin\" (FAXINFO #0.0# #0.0# \"Unknown ID\" \"\" \"\" #6.0# #0.0# #33.0# #1.0# \"12040910\" \"04/12/2002-09:10:38\" \"04/12/2002-09:10:38\") ]  bye HALT } ";
