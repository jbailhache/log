...
public class expr
{
 ...
 expr (String nd, double x, String s)
 {
  noeud = nd;
  valeur = x;
  chaine = s;  
 ...
 String rep (boolean conv)
 {
  return rep (carspec, conv);
 }

 String rep (String carspec, boolean conv)
 {
  /*System.out.println ("1: valeur="+valeur);*/
  if (noeud.equals ("NBR"))
   /* return "#" + valeur + "#"; */
  ...
  for (int i=0; i<arite; i++)
   /*r += " " + sousexpr[i].rep();*/
   r += carspec.charAt(0) + sousexpr[i].rep(carspec,conv);
  r += /*")"*/ carspec.charAt(7);
  return r;
 }

 String rep1 (String carspec)
 {
  /*System.out.println ("1: valeur="+valeur);*/
  if (noeud.equals ("NBR"))
   /* return "#" + valeur + "#"; */
  ...
  for (int i=0; i<arite; i++)
   /*r += " " + sousexpr[i].rep();*/
   r += carspec.charAt(0) + sousexpr[i].rep1(carspec);
  r += /*")"*/ carspec.charAt(7);
  return r;
 }


 String repf (String carspec)
 {
  /*System.out.println ("1: valeur="+valeur);*/
  if (noeud.equals ("NBR"))
   /* return "#" + valeur + "#"; */
  ...
  for (int i=0; i<arite; i++)
   /*r += " " + sousexpr[i].rep();*/
   r += carspec.charAt(0) + sousexpr[i].rep(carspec);
  r += /*")"*/ carspec.charAt(7);
  return r;
 }
