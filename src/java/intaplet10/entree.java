 ...
 */
 ...
 public expr add (expr x, expr y)
 {
  if (x.arite != 2)
	return new expr ("SEQ", y, x);
  else 
	return new expr (x.noeud, x.sousexpr[0], add (x.sousexpr[1], y));
 }
 ...
 expr lirexpr1 ()
 {
   ...
   */
   ...
   expr r1 = new expr (node, val, str, arite, sousexpr);
   /*System.out.println ("2:val="+r1.valeur);*/
   /*System.out.println (r1.rep());*/
   return r1;
  }
