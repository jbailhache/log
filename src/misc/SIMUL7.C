...
/* Castorama */
float cours1[] = { 248.8, 248.8, 249, 249, 249, 249.5, 250, 249.5, 249.5, 250, 249.5, 250, 249.7, 249.5, 249.4,
...
/* Bull 30-8 */
float cours2[] = { 7.44, 7.44, 7.44, 7.42, 7.41, 7.44, 7.44, 7.42, 7.45, 7.44, 7.44, 7.44, 7.42,
...
/* CFF 30-8 */
float cours3[] = { 13.77, 13.74, 13.71, 13.68, 13.65, 13.62,
...
/* Metaleurop 30-8 */
float cours4 [] = { 7.4, 7.39, 7.395, 7.4, 7.41, 7.42, 7.43, 7.44, 7.44, 7.42, 7.4, 7.41, 7.413,
...
simul (float d, float capital_init)
{
long t, nt, nta;
float capital;
...
*/
	...
	for (d=0.001; d<10; d*=1.1)
		simul (d, 2000000/Euro);


	for (c=1000/Euro; c<20000000/Euro; c*=2)
		simul (0.045, c);
